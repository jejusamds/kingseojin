...
var TREE_NODE_ROOT_IMG = "../img/tree/Common_TreeNode_FolderRoot.gif";
var TREE_FOLDER_OPEN_IMG = "../img/tree/Common_TreeNode_FolderOpen.gif";
var TREE_FOLDER_CLOSED_IMG = "../img/tree/Common_TreeNode_FolderClosed.gif";

var TREE_LINE_OPEN_IMG = "../img/tree/Common_TreeNode_LineNodeOpen.gif";
var TREE_LINE_CLOSED_IMG = "../img/tree/Common_TreeNode_LineNodeClosed.gif";
var TREE_LINE_LAST_IMG = "../img/tree/Common_TreeNode_LineLast.gif";
var TREE_LINE_LAST_OPEN_IMG = "../img/tree/Common_TreeNode_LineLastOpen.gif";
var TREE_LINE_LAST_CLOSED_IMG = "../img/tree/Common_TreeNode_LineLastClosed.gif";

var TREE_LINE_NODE_IMG = "../img/tree/Common_TreeNode_LineNode.gif";
var TREE_LINE_VERT_IMG = "../img/tree/Common_TreeNode_LineVert.gif";
var TREE_LINE_BLANK = "../img/tree/Common_TreeNode_Blank.gif";

var TREE_NODE_LEAF_IMG = "../img/tree/Common_TreeNode_Note.gif";

var TREE_NODE_MMATOP_IMG= "../img/tree/MMAReport_Top_Root.gif";
...
{
	TREE_NODE_ROOT_IMG = "../.../img/tree/Common_TreeNode_FolderRoot.gif";
	TREE_FOLDER_OPEN_IMG = "../.../img/tree/Common_TreeNode_FolderOpen.gif";
	TREE_FOLDER_CLOSED_IMG = ".../img/tree/Common_TreeNode_FolderClosed.gif";

	TREE_LINE_OPEN_IMG = "../.../img/tree/Common_TreeNode_LineNodeOpen.gif";
	TREE_LINE_CLOSED_IMG = "../.../img/tree/Common_TreeNode_LineNodeClosed.gif";
	TREE_LINE_LAST_IMG = "../.../img/tree/Common_TreeNode_LineLast.gif";
	TREE_LINE_LAST_OPEN_IMG = "../.../img/tree/Common_TreeNode_LineLastOpen.gif";
	TREE_LINE_LAST_CLOSED_IMG = "../.../img/tree/Common_TreeNode_LineLastClosed.gif";

	TREE_LINE_NODE_IMG = "../.../img/tree/Common_TreeNode_LineNode.gif";
	TREE_LINE_VERT_IMG = "../.../img/tree/Common_TreeNode_LineVert.gif";
	TREE_LINE_BLANK = "../.../img/tree/Common_TreeNode_Blank.gif";

	TREE_NODE_LEAF_IMG = "../.../img/tree/Common_TreeNode_Note.gif";

	TREE_NODE_MMATOP_IMG= "../.../img/tree/MMAReport_Top_Root.gif";
}
...
function treeNodeOnClick(id) {
	...
	if(event.srcElement.id == id+"_text") { 
		...
		if(nodeComp.action != null) {
			exec(nodeComp.action, "JavaScript");
		}
...
function treeNodeOnContextMenu(id) {
	...
	if(objNodeComp.onContextMenu) {
		exec(objNodeComp.onContextMenu);
