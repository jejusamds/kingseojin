...
/** report icon */
var REPORT_ICON = "../img/tree/SiteReport_Report.gif";

/** Data Icon */
var DATA_ICON = "../img/tree/Common_Data.gif";


/** System Defined Buttons */
var ADD_BUTTON = "../img/tree/Common_Add.gif";
var DELETE_BUTTON = "../img/tree/Common_Delete.gif";
var PROPERTY_BUTTON = "../img/tree/Common_Property.gif";
var OK_BUTTON = "../img/tree/Common_Ok.gif";
var CANCEL_BUTTON = "../img/tree/Common_Cancel.gif";
var EDIT_BUTTON = "../img/tree/Common_Edit.gif";
var FIND_BUTTON = "../img/tree/Common_Find.gif";
var DOWNLOAD_EXCEL_BUTTON = "../img/tree/Common_Download_Excel.gif";
var HELP_BUTTON = "../img/tree/Common_Help.gif";
var NEXT_BUTTON = "../img/tree/Common_Next.gif";
var PREV_BUTTON = "../img/tree/Common_Prev.gif";
var CHANGENAME_BUTTON = "../img/tree/Common_ChangeName.gif";
var MERGE_FRAME_BUTTON = "../img/tree/Common_Merge_Frame.gif";
var DIVIDE_FRAME_BUTTON = "../img/tree/Common_Divide_Frame.gif";
var PRINT_BUTTON = "../img/tree/Common_Print.gif";
var SAVE_BUTTON = "../img/tree/Common_Save.gif";
var SAVEAS_BUTTON = "../img/tree/Common_SaveAs.gif";
var SMALLER_BUTTON = "../img/tree/Common_Smaller.gif";
var LARGER_BUTTON = "../img/tree/Common_Larger.gif";
var OPEN_BUTTON ="../img/tree/Common_Open.gif";
var EXECUTE_BUTTON = "../img/tree/Common_Ok.gif";
var CLOSE_BUTTON = "../img/tree/Common_Close.gif";

var ADD_BUTTONICON = "../img/tree/Common_Button_Add.gif";
var EDIT_BUTTONICON = "../img/tree/Common_Button_Edit.gif";
var MODIFY_BUTTONICON = "../img/tree/Common_Button_Modify.gif";
var DELETE_BUTTONICON = "../img/tree/Common_Button_Delete.gif";
var CANCEL_BUTTONICON = "../img/tree/Common_Button_Cancel.gif";
var VIEW_BUTTONICON = "../img/tree/Common_Button_View.gif";
var UP_BUTTONICON = "../img/tree/Common_Button_Up.gif";
var DOWN_BUTTONICON = "../img/tree/Common_Button_Down.gif";
var SAVE_BUTTONICON = "../img/tree/Common_Button_Save.gif";
var SELECT_BUTTONICON = "../img/tree/Common_Button_Select.gif";
var SEARCH_BUTTONICON = "../img/tree/Common_Button_Search.gif";
var OK_BUTTONICON = "../img/tree/Common_Button_OK.gif";
var INIT_BUTTONICON = "../img/tree/Common_Button_Init.gif";
var REGISTER_BUTTONICON = "../img/tree/Common_Button_Register.gif";
var SERVERSTART_BUTTONICON = "../img/tree/Common_Button_ServerStart.gif";
var SERVERSTOP_BUTTONICON = "../img/tree/Common_Button_ServerStop.gif";
var EXAMINE_BUTTONICON = "../img/tree/Common_Button_Examine.gif";
var NEXT_BUTTONICON = "../img/tree/Common_Button_Next.gif";
var PREV_BUTTONICON = "../img/tree/Common_Button_Prev.gif";



var DATA_LIST = "../img/tree/Common_List_Data.gif";
var DATASELECTED_LIST = "../img/tree/Common_List_DataSelected.gif";
var USER_LIST = "../img/tree/Common_List_User.gif";
var USERSELECTED_LIST = "../img/tree/Common_List_UserSelected.gif";
var MESSAGE_LIST = "../img/tree/Common_List_Message.gif";
var MESSAGESELECTED_LIST = "../img/tree/Common_List_MessageSelected.gif";
